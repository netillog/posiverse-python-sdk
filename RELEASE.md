...
`0.1.0` is the first public PyPI release of a single package (no separate production branch). Intentional pre-1.0 breaking changes for public consumers:
...
1. Ensure CI is green on the commit you intend to ship (`ruff`, `pytest`, `pip-audit`).
